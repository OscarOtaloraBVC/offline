...
#     password: str = Field(..., description="Contraseña del admin para descifrar las llaves")
...
#         logger.info(f"Usuario {user['username']} guardó {len(keys)} llaves en bulk")
...
#         logger.info(f"Usuario {user['username']} reordenó las llaves: {order}")
        
#         return {"message": "Orden actualizado correctamente", "success": True}
#     except HTTPException:
#         raise
#     except Exception as e:
