...
Este Proyecto contiene los manifiestos de Kubernetes para el despliegue de Apache DevLake (v1.0.2) utilizando MariaDB (MariaDB 10.6.25) como motor de base de datos persistente. El despliegue está diseñado para entornos en clusters K3d.
...
Adicionar el repo helm repo add devlake https://apache.github.io/devlake-helm-chart
