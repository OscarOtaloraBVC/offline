...
**Tipo:** API contract-first basada en OpenAPI
**Artefacto principal:** `api-offchain/specs/offchain-api.yaml`

**Descripción:**  
La Off-Chain API se implementa bajo un enfoque contract-first, donde la especificación OpenAPI es el artefacto central del diseño.
Esta API expone información off-chain complementaria a la blockchain (metadata, transacciones, precios de referencia) de forma estandarizada, desacoplada del runtime, y fácilmente integrable por consumidores internos y externos.

#### 3.3.1 Submódulos Principales

Los endpoints están definidos exclusivamente en `specs/offchain-api.yaml`.

**Metadata de Contratos**
`GET /offchain/contracts/{contractId}/metadata`

**Responsabilidad:**
- Exponer metadata contextual de contratos inteligentes
- Retornar ABIs, parámetros y configuraciones relevantes

**Detalles de Transacciones**
`GET /offchain/transactions/{txHash}/details`

**Responsabilidad:**
- Proveer información extendida de transacciones
- Facilitar auditoría y trazabilidad off-chain

**Precios de Referencia**
`GET /offchain/prices/{asset}`

**Responsabilidad:**
- Exponer valores de referencia (e.g. tasas, precios)
- Mantener histórico off-chain para valoración de eventos
