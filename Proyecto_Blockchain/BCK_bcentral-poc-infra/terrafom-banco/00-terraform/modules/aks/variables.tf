...
variable "flux_repo_url" {
  ...
  default     = "https://Bcentral-Arquitectura@dev.azure.com/Bcentral-Arquitectura/ETAD/_git/bcentral-poc-infra"
}
...
variable "vnet_subnet_id" {
  description = "The ID of the Subnet where the AKS worker nodes should reside."
  type        = string
}